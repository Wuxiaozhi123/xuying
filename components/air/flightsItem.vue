<template>
  <div class="flight-item" >
    ...
    <div class="flight-recommend" v-if="conceal">
      <!-- 隐藏的座位信息列表 -->
...
export default {
  ...
  computed: {
    time() {
      ...
      const minute =end_min-start_min;
      const xiaoshi = Math.floor(minute / 60);
      const fangzong = minute % 60;
      return `${xiaoshi}时${fangzong}分`;
    }
  },
  props: {
    // 数据
